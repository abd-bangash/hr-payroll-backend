...
const userValidation = {
  register: Joi.object({
    ...
    role: Joi.string().valid('SuperAdmin', 'Admin', 'HR', 'Finance', 'Employee').optional()
  }),
...
const employeeValidation = {
  create: Joi.object({
    ...
    employmentDetails: Joi.object({
      type: Joi.string().valid('Permanent', 'Contractual', 'Freelancer').required(),
    ...
    salaryDetails: Joi.object({
      ...
      payFrequency: Joi.string().valid('Monthly', 'Bi-weekly', 'Weekly').default('Monthly'),
...
const leaveValidation = {
  create: Joi.object({
    leaveType: Joi.string().valid('Annual', 'Sick', 'Maternity', 'Paternity', 'Personal', 'Emergency').required(),
    startDate: Joi.date().required(),
    endDate: Joi.date().required(),
